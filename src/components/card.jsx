    ...
    <div data-testid="movie-card" className="h-[520px] w-[250px] mt-[20%]">
      ...
      <div className="">
        <p
          ...
          className="text-gray mt-4 text-[12px]"
        >
          {date}
        </p>

        <div className="mt-4">
          <h2 data-testid="movie-title" className="text-[18px] font-semibold">
            {title}
          </h2>
        </div>
        <div className="flex justify-between mt-4 ">
          <h className="flex text-[12px] ml2 items-center">
            <img className="mr-3" src={imdb}></img> {rating}
          </h>
          <h className=" flex text-[12px] mr-2  items-center">
            {" "}
            <img className="mr-3" src={tomatoIcon}></img> {tomato}
          </h>
        </div>
